...
. sources/meta-winsys/imx/tools/utils.sh
...
if [ -z "$MACHINE" ]; then
    ...
    MACHINE='imx8mqpicoitx'
fi

# copy new EULA into community so setup uses latest i.MX EULA
cp sources/meta-winsys/imx/EULA.txt sources/meta-freescale/EULA
...
META_FSL_BSP_RELEASE="${CWD}/sources/meta-winsys/imx/meta-bsp"

echo "" >> $BUILD_DIR/conf/bblayers.conf
echo "# Freescale Yocto Project Release layers" >> $BUILD_DIR/conf/bblayers.conf
hook_in_layer meta-winsys/imx/meta-bsp
