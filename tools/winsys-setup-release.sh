...
echo "    git://source.codeaurora.org/quic/la/platform/vendor/qcom-opensource/wlan/utils/ git://github.com/qca/ \n \\" >> conf/local.conf
echo "    https://source.codeaurora.org/quic/la/platform/vendor/qcom-opensource/wlan/utils/ https://github.com/qca/ \n \\" >> conf/local.conf
echo "    http://source.codeaurora.org/quic/la/platform/vendor/qcom-opensource/wlan/utils/ http://github.com/qca/ \n \\" >> conf/local.conf
echo "\"" >> conf/local.conf
